          ...
          <div className="block">
            ...
            <CardContent className="text-sm">
              <p>
                ...
                US$6,2 miliar (75 persennya ditanggung Jepang berupa pinjaman
                tenor 40 thn dan bunga 0,1 persen). Menurut kajian, proyek
                kereta cepat sulit dgn skema b to b atau tanpa jaminan
                pemerintah. China pun dtg skema menggiurkan
              </p>
            </CardContent>
          </div>
        </div>
